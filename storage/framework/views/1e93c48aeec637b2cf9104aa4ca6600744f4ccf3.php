...
<?php $__env->startSection('content'); ?>	
	 <section class="content-header"><h1>Social Setting</h1></section>
...
<div class="row">
    <div class="col-xs-12 ">
        <div class="box">
            ...
            <div class="box-body">
                 <div class="caption">
                <button id="btn_add" name="btn_add" class="btn btn-primary "><i class="fa fa-plus"></i> Add New Social</button></div><br>
                    ...
                    <table class="table table-striped">
                        ...
                        <?php $__currentLoopData = $social; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="product<?php echo e($product->id); ?>">
                                ...
                                <td>
                                    <button class="btn btn-primary btn-detail open_modal " value="<?php echo e($product->id); ?>"><i class="fa fa-edit"></i> EDIT</button>
                                    <button type="button" class="btn btn-danger delete_button" data-toggle="modal" data-target="#DelModal" data-id="<?php echo e($product->id); ?>"> <i class='fa fa-trash'></i> DELETE</button>
                                </td>
                            </tr>
...
<script type="text/javascript">
        ...
        var url = '<?php echo e(url('/social-settings')); ?>';

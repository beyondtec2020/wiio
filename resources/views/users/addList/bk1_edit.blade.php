...
<!-- Titlebar -->
		<div id="titlebar">
			<div class="row">
				<div class="col-md-12">
					<h2>Edit-List</h2>
                    <a href="{{ URL::previous() }}" type="button" class="pull-right btn  btn-info btn-flat"><i class="fa fa-arrow-left"></i> <b>Back </b> </a>
				</div>
			</div>
		</div>
                ...
                {{csrf_field()}}
                    	...
                    	<div class="add_listing_info">
                            ...
                            <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" name="title" class="form-control" value="{{$AddList->title}}">
                                {!! $errors->first('title', '<p class="help-block">:message</p>') !!}
                                </div>
                            <div class="form-group {{ $errors->has('short_description') ? 'has-error' : ''}}">
                                <label class="label-title">Short Description</label>
                                <input type="text" value="{{$AddList->short_desc}}" name="short_description" class="form-control">
                        ...
                        <div class="add_listing_info">
                            ...
                            <div class="form-group {{ $errors->has('address') ? 'has-error' : ''}}">
                                ...
                                <input type="text" value="{{$AddList->address}}" name="address" class="form-control">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 {{ $errors->has('zip_code') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" name="zip_code" value="{{$AddList->zip_code}}" class="form-control">
                                ...
                                <div class="form-group col-sm-6 {{ $errors->has('phone') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" name="phone" value="{{$AddList->phone}}" class="form-control">
                            ...
                            <div class="row">
                            	<div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="email" value="{{$AddList->email}}" class="form-control">
                                </div>
	                            <div class="form-group col-sm-6">
                            ...
                            <div class="row">
            	                <div class="form-group col-md-3 col-sm-6">
                                    ...
                                    <input type="text" value="{{$AddList->facebook}}" name="facebook" class="form-control">
                                </div> 
        	                    <div class="form-group col-md-3 col-sm-6">
                        ...
                        <div class="add_listing_info">
                            ...
                            <div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
                                ...
                                <textarea class="form-control" name="description">{{$AddList->description}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <p>
                                <input type="checkbox" id="amenities{{++$k}}" name="amenities[{{$j++}}]" value="{{$data->id}}" @foreach($addlistAmenity as  $ss) {{$ss->amenities_id == $data->id ? 'checked' : ''}} @endforeach >
                        ...
                        <div class="add_listing_info">
                            ...
                            <div class="row">			
                                <div class="form-group col-sm-6 {{ $errors->has('min_price') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" name="min_price" value="{{$AddList->min_price}}" class="form-control" min="0">
                                 ...
                                 <div class="form-group col-sm-6 {{ $errors->has('max_price') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" name="max_price" value="{{$AddList->max_price}}" class="form-control" min="0">
                        ...
                        <div class="add_listing_info">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="video" value="{{$AddList->video}}" class="form-control">
                            </div>      
                        </div>
                        ...
                        <div class="add_listing_info">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="location" value="{{$AddList->location}}" class="form-control">
                            </div>      
                        </div>
                            ...
                            <div class="row">
                              ...
                              {!! $errors->first('images', '<p class="help-block" style="color: red">:message</p>') !!}
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3" >
                                    @if($k != 0)
                                    <a href="{{url('/del-list-single-image/'.$v->id)}}" class="close" aria-label="Close" onclick="return checkDelete();">

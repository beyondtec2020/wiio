...
@section('style')
    ...
    <style type="text/css">
        ...
        {{asset('public/assets/images/listing_img2.jpg')}} );*/
                    ...
                    <div class="col-md-5">
                        <div class="pricing_info">
                            <p class="listing_price">
                                ...
                                <del>{{number_format($data->min_price, 2, ",","")}}</del>
                                -
                                <span>porR$</span> {{number_format($data->max_price, 2, ",", "")}}
                            </p>
                            <div class="listing_message">
                                @if(!Sentinel::getUser())
                                    <a href="{{url('/login')}}?redirect_to={{ urlencode(Request::url()) }}" class="btn">
                        ...
                        <div id="listing_img_slider2">
                            <div class="owl-carousel owl-theme">
                                @foreach($data->CountImage()->get() as $d)
                                    <div class="item"><img src="{{asset('public/images/'.$d->image)}}" alt="image">
                                    </div>
                                @endforeach
                            </div>
                        </div>
                                    ...
                                    <div class="panel-body">
                                        <ul>
                                            @foreach($data->totalAmenity()->get() as $d)
                                                ...
                                                @if($v != null)
                                                    <li><a href="#"> <i class="fa fa-check-square"></i> {{$v->name}}
                                                        </a></li>@endif
                                            @endforeach
                    ...
                    <!-- /Listing-Map -->
                                ...
                                <div class="review_wrap">
                                    ...
                                    <div class="review_detail">
                                        ...
                                        @if($v->rating ==null)0
                                            ...
                                            <p><i class="fa fa-clock-o"></i> {{$v->created_at->toDayDateTimeString()}}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="writereview" class="review_form">
                            @if(Sentinel::getUser())
                                ...
                                <form action="{{url('/review-post')}}" method="post" data-toggle="validator"
                                      id="reviewForm">
                                    {{csrf_field()}}
                                    <input type="hidden" name="postId" value="{{$data->id}}">
                            ...
                            @else
                                ...
                                <div class="panel panel-login">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <form id="login-form" action="{{url('/login-review')}}" method="post"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-lg-3"><a href="{{url('/forgot-password')}}"
                                                                                     tabindex="5"
                                                                                     class="forgot-password">Esqueceu
                                                                    Senha?</a>
                                                            </div>
                                                            <div class="col-lg-6">Caso não tem uma conta?
                                                                <a href="{{url('/register')}}" tabindex="5"
                            ...
                            <ul>
                                ...
                                @if($data->email != null)
                                    <li><i class="fa fa-envelope"></i> <a
                                                href="mailto:{{$data->email}}">{{$data->email}}</a></li>@endif

                                @if($data->website != null)
                                    <li><i class="fa fa-link"></i> <a href="{{$data->website}}"
                                                                      target="_blank">{{$data->website}}</a></li>@endif
                            </ul>
                            <div class="social_links">
                                @if($data->facebook != null)
                                    <a href="{{$data->facebook}}" class="facebook_link" target="_blank"><i
                                                class="fa fa-facebook-f"></i></a>
                                @endif
                                @if($data->linkdin != null)
                                    <a href="{{$data->linkdin}}" class="linkedin_link" target="_blank"><i
                                                class="fa fa-linkedin"></i></a>
                                @endif
                                @if($data->twitter != null)
                                    <a href="{{$data->twitter}}" class="twitter_link" target="_blank"><i
                                                class="fa fa-twitter"></i></a>
                                @endif
                                @if($data->google != null)
                                    <a href="{{$data->google}}" class="google_plus_link" target="_blank"><i
                        ...
                        <div class="" style="padding-bottom: 20px;">
                            @foreach($A300X250 as $v)
                                <a href="{{url('/click-add/'.$v->id)}}" target="_blank">
                                    @if($v->advert_type == 1)
                                        <img class="img-responsive" src="{{asset('public/images/advertise/'.$v->val1)}}"
                        ...
                        <div class="sidebar_wrap ">
                            ...
                            <div class="listing_video">
                                <ul>
                                    @foreach($cat as $dat)
                                        <li>
                                            <a href="{{url('/single-category/'.$dat->id.'/'.$dat->slug)}}">{{$dat->name}}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                                    ...
                                    @foreach($latest as $da)
                                        <div class="post_wrap">
                                            <div class="text-center">
                                                <h6>
                                                    <a href="{{url('/single-post/'.$da->id.'/'.$da->slug)}}">{{str_limit($da->title,25,'..')}}</a>
                                                </h6>
                                            </div>
                                            <div class="post_img">
                                                <div class="listing_cate">
                                                    <span class="cate_icon">
                                                        ...
                                                        <img src="{{asset('public/images/'.$da->cat->cat_image)}}"
                                                             alt="icon-img"></a>
                                                    </span>
                                                </div>
                                                <a href="{{url('/single-post/'.$da->id.'/'.$da->slug)}}">
                                                    <img src="{{asset('public/images/'.$da->CountImage()->first()->image)}}"
                                                         alt="image"></a>
                                                <div class="text-center selo">
                                                    <div class="selo-content">
                                                        <span class="selo-text">{{ abs(round(100 - ($da->max_price* 100) / $da->min_price)) }}
                                                            %</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="post_info">
                                                ...
                                                <div class="post_meta">
                                                    ...
                                                    <p class="listing_map_m pull-right"><i
                                                                class="fa fa-map-marker"></i> {{$da->city->name}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach

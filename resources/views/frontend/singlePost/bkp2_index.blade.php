        	...
        	<div class="row">
                ...
                <div class="col-md-4">
                	<div class="pricing_info">
                        <p class="listing_price"><span>$</span>{{$data->min_price}} - <span>$</span>{{$data->max_price}}</p>
	...
	<div class="container">
        	<div class="sidebar_wrap listing_action_btn">
                <ul>
                    ...
                    <li><a href="#writereview" class="js-target-scroll"> <i class="fa fa-star"></i> Escreva um comentário</a></li>
                    @if(Sentinel::getUser())
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-3"><a href="{{url('/forgot-password')}}" tabindex="5" class="forgot-password">Forgot Password?</a>
                                            </div>
                                            <div class="col-lg-6">Don't have an account?
                                                    <a href="{{url('/register')}}" tabindex="5" class="forgot-password"> Signup Here</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                @foreach($latest as $data)
                                        <div class="listing_wrap">
                                            <div class="listing_img video-list-thumbs">
                                                <a href="{{url('/single-post/'.$data->id.'/'.$data->slug)}}"><img src="{{asset('public/images/'.$data->CountImage()->first()->image)}}" alt="">
                                                </a>
                                            </div>
                                            <div class="listing_info">
                                                <h4 class="text-center bold"><a href="{{url('/single-post/'.$data->id.'/'.$data->slug)}}">{{$data->title}}</a></h4>
                                            ...
                                            @endswitch
                                                    ...
                                                    <div class="post_category pull-right">
                                                        <a href="{{url('/single-category/'.$data->cat->id.'/'.$data->cat->slug)}}">{{$data->cat->name}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

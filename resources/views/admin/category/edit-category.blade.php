...
<a href="{{url('/category')}}" type="button" class="pull-right btn  btn-info btn-flat"><i class="glyphicon glyphicon-arrow-left"></i> <b> Back </b> </a>
</section><br>
      ...
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <div class="col-sm-9 col-sm-offset-2">@include('errors.errors')</div>
             ...
             <form action="{{url('/update-category')}}" method="post" class="form-horizontal" enctype="multipart/form-data" name="editCategoryForm">
              {{csrf_field()}}
            ...
            <input type="hidden" name="id" value="{{$category->id}}">
                ...
                <div class="form-group">
                  <label for="" class="col-sm-2  control-label">
                    Position :</label>
                  <div class="col-sm-9">
                  <input type="text" name="position"  id="position" class="form-control" placeholder=" menu position must be number" required autofocus pattern="\d*" min="0" value="{{$category->position}}">
                  </div>
                </div>
                <div class="form-group">
      ...
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
             ...
             <form action="{{url('/update-catImage')}}" method="post" class="form-horizontal" enctype="multipart/form-data" >
              {{csrf_field()}}
            ...
            <input type="hidden" name="id" value="{{$category->id}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <br>
                    <img src="{{asset('public/images/'.$category->cat_image)}}">
                  </div>
                </div>
            </div>
            <!-- /.box-body -->

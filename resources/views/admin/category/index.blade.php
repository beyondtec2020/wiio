...
<a href="{{url('/add-category')}}" type="button" class="pull-right btn  btn-info btn-flat"><i class="fa fa-plus"></i> <b>Add Category </b> </a>
</section>
                    ...
                    @foreach($category as $k=>$cat)
                        <tr>
                          ...
                          <td>{{++$k}}</td>
                           ...
                           <td class="">
                              <img src="{{asset('public/images/'.$cat->cat_image)}}" /> 
                           </td>
                            ...
                            <td class="">
                              <a class="btn btn-primary btn-xs" href="{{url('/edit-category/'.$cat->id)}}">
                                ...
                                <a class="btn btn-danger btn-xs" href="{{url('/del-category/'.$cat->id)}}" onclick="return checkDelete()">

    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form action="{{route('updateRole')}}" method="post" role="form" class="form-horizontal" name="editRole" >
            {{ csrf_field() }}
            <div class="box-body">
              <input type="hidden" name="id" value="{{$user->id}}">
    ...
    <div class="row">
      <div class="col-xs-12 ">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form action="{{route('updatePassw')}}" method="post" role="form" class="form-horizontal">
            {{ csrf_field() }}
            <div class="box-body">
              <input type="hidden" name="id" value="{{$user->id}}">
              <div class="form-group">
